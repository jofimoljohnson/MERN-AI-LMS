...
const About = () => {
    return (
        <>
            <div className="w-[100vw] lg:h-[70vh] min-h-[70vh] min-h-[50vh] flex flex-wrap items-center justify-center gap-2 mb-[30px]">
                {/* image area */}
                <div className="lg:w-[40%] md:w-[80%] w-[100%] h-[100%] flex items-center justify-center relative">
                    <img src={about} alt="" className="w-[80%] h-[90%] rounde-lg" />
                ...
                <div className="lg:w-[50%] md:w-[70%] w-[100%] h-[100%] flex items-start justify-center flex-col px-[35px] md:px-[80px]">
                    ...
                    <div className="text-[15px]">
                        We provide a modern Learning Management System to simplify online education,track progress,and
                        enhance student-instuructor collaboration efficiently
                    </div>
                    <div className="w-[100%] lg:w-[60%]">
                        <div className="flex items-center justify-between mt-[40px]">
                            <div className="flex items-center justify-center gap-[10px]">
                                <FaCircleCheck className="w-[20px] h-[20px]" />
                                Simplified Learning
                            </div>
                            <div className="flex items-center justify-center gap-[10px]">
                                <FaCircleCheck className="w-[20px] h-[20px]" />
