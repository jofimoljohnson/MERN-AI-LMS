            ...
            <div className="w-full min-h-screen p-4 sm:p-6 bg-gray-100">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <h1 className="text-xl sm:text-2xl font-semibold">All Created Courses</h1>
                    </div>

                    <button
                        className="bg-black text-white px-4 py-2 rounded hover:bg-gray-600 w-full sm:w-auto"
