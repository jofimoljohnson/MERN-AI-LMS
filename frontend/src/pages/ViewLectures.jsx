    ...
    return (
        <>
            <div className="min-h-screen bg-gray-50 p-6 flex flex-col md:flex-row gap-6">
                {/* left or top */}
                <div className="w-full md:w-2/3 bg-white rounded-2xl shadow-md p-6 border-b-gray-200">
                    <div className="mb-6">
                        ...
                        <div className="mt-2 flex gap-4 text-sm text-gary-500 font-medium">
                    ...
                    <div className="aspect-video bg-black rounded-xl overflow-hidden mb-4 border border-gray-300">
                        {selectedLecture?.videoUrl ? (
                            <video src={selectedLecture?.videoUrl} className="w-full h-full object-cover" controls />
                        ) : (
                        ...
                        {selectedCourse?.lectures?.length > 0 ? (
                            selectedCourse?.lectures?.map((lecture, index) => (
                                ...
                                >
                                   ...
                                   <IoPlayCircleSharp className="text-lg text-black "/>
                                </button>
                            ))
                        ) : (
